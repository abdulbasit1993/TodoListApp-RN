...
export default () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Sign In to Todo List</Text>
      <View style={{flex: 1}}>
        <LabeledInput
          label="Email"
      ...
      <Button
        onPress={() => {
          ...
          if (!isValid.password) {
            passwordField.errorMessage =
              'Password must be at least 6 long with numbers, uppercase, lowercase, and symbol characters';
        ...
        buttonStyle={{backgroundColor: '#6100ED'}}
...
const styles = StyleSheet.create({
  ...
  header: {fontSize: 35, color: '#6100ED', alignSelf: 'center', padding: 20},
});
